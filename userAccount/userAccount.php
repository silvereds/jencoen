                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="coupon-accordion">
                                <h3><span ><a href="wishlist.php"> your wishlist</a></span></h3>
                                <!-- ACCORDION START -->
                                <h3><span id="showlogin">your personnal informations</span></h3>
                                            ...
                                            <div class="checkbox-form"  >	
                                                ...
                                                <div class="row"  >
                                                    ...
                                                    <div class="col-md-12" style="margin-top:1em">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="checkout-form-list create-acc col-md-3">
                                                                <a class="btn-style cr-btn" href="#!" id="save-first-adresse">
                                                                    <span style="color:white">save infos</span>
                                                                </a>	
                                                        ...
                                                        <form id="form2"  action="#" class="row" hidden="true" style="background:#748f9e">
                                                            <div class="col-md-6" >
                                                                <div class="checkout-form-list">
                                                                    <label>your last password  <span class="required">*</span></label>										
                                                            ...
                                                            <div class="row col-md-12"  id="controls-password">
                                                                <div class="checkout-form-list create-acc col-md-6">
                                                                    <a class="btn-style cr-btn" href="#!" id="save-newPassword">
                                                                        <span style="color:white">save new password</span>
                                                                    </a>	
                                                ...
                                                <div class="different-address">
                                                    <div class="ship-different-title" style="border:none">
                                                        <h3 >
                                                            <label>Infos of your second address?</label>
                                                    ...
                                                    <div id="ship-box-info" class="row">
                                                        ...
                                                        <form id="form3" action="#" class="row" style="background:#d5efe4"> 
                                                            <div class="col-md-6">
                                                                <div class="checkout-form-list">
                                                                    <label>Name and Last Name <span class="required">*</span></label>										
                                                            ...
                                                            <div    id="controls-second-adress" class="row col-md-12">
                                                                    <div class="checkout-form-list create-acc col-md-3">
                                                                        <a class="btn-style cr-btn" href="#!" id="save-second-adress">
                                                                            <span style="color:white">save second adress</span>
                                                                        </a>	
                                ...
                                <!-- ACCORDION END -->	
                                <!-- ACCORDION START -->
                                <h3><span id="showcoupon"><i class="zmdi zmdi-favorite"></i>ODER HISTORY AND DETAILS</span></h3>
                                   <div id="checkout_coupon" class="coupon-checkout-content">
                                        <div class="row">
                                            <div class="col-md-3"><label>choose date  <span class="required">*</span></label></div>
                                            <div class="col-md-6">
                                                <div class="checkout-form-list">										
                                            ...
                                            <div class="checkout-form-list create-acc col-md-3">
                                                <a class="btn-style cr-btn" href="#!" id="show-order">
                                                    <span style="color:white">show details order</span>
                                                </a>	                   
                                            </div>
                                        </div>

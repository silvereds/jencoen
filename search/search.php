        ...
        <div class="wrapper">
            ...
            <?php
             if(isset($_GET['name'])){
                ...
                if(getIdProductByName($_GET['name']) == ""){
            ?>
                <div class="col-md-12" style="height:20em"><h3 class="text-center">aucun article ne correspondant à ce nom</h3> </div>
            <?php
                }else{
                   
                    ProductDetail(getIdProductByName($_GET['name']));  
                }
            }
            ?>
                            ...
                            <div class="col-lg-3 col-md-6 col-12">
                                <div class="footer-widget mb-30">
                                    ...
                                    <div class="footer-about">
                                        <p><span>JENCOEN</span> the most latgest bike store in the wold can serve you latest ulity of motorcycle soucan sell here your motorcycle it quo </p>
